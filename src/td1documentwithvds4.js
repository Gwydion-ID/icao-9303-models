...
import { TD1Document } from './td1document.js';
 ...
 *     (VDS). The USA's passport card, most state identification cards, and
 *     credit cards are examples of the size of this type of document.
 */
export class TD1DocumentWithVDS4 {
  /**
   * Create a `TD1DocumentWithVDS4`.
  ...
  // The objects `TD1DocumentWithVDS4` uses to compose itself
  #document;
  #digitalseal;
