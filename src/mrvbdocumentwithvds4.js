 ...
 *     a machine-readable zone and a version 4 visible digital seal. These visas
 ...
 *     the passport page.
 */
export class MRVBDocumentWithVDS4 {
  /**
   * Create a `MRVBDocumentWithVDS4`.
  ...
  // The objects `MRVBDocumentWithVDS4` uses to compose itself
  #document;
  #digitalseal;
