 ...
 *     machine-readable zone and a version 3 visible digital seal (VDS). These
 ...
 *     passport page.
 */
export class MRVADocumentWithVDS3 {
  /**
   * Create a `MRVADocumentWithVDS3`.
  ...
  // The objects `MRVADocumentWithVDS3` uses to compose itself
  #document;
  #digitalseal;
