...
import { TD2Document } from './td2document.js';
import { DigitalSealV4 } from './digitalsealv4.js';

/**
 * Stores properties and methods for TD2-sized machine-readable travel documents
 *     (MRTDs) with a machine-readable zone and a version 4 visible digital seal
 *     (VDS). The Icelandic identity card before December 2023 and some Emergency
 *     Travel Documents (ETDs) are example documents of the same size as a TD2.
 */
export class TD2DocumentWithVDS4 {
  /**
   * Create a `TD2DocumentWithVDS4`.
  ...
  // The objects `TD2DocumentWithVDS4` uses to compose itself
  #document;
  #digitalseal;
