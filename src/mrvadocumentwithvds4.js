...
import { MRVADocument } from './mrvadocument.js';
import { DigitalSealV4 } from './digitalsealv4.js';

/**
 * Stores properties and methods for machine-readable visas (MRV-A) with a
 *     machine-readable zone and a version 4 visible digital seal (VDS). These
 *     visas are used when additional information is placed on the visa sticker
 *     and clear zones along the visa sticker is unnecessary for the
 *     passport page.
 */
export class MRVADocumentWithVDS4 {
  /**
   * Create a `MRVADocumentWithVDS4`.
  ...
  constructor(opt) {
    ...
    this.#digitalseal = new DigitalSealV4();
    ...
    this.optionalData = opt?.optionalData ?? "6ZE184226B";
  ...
  // The objects `MRVADocumentWithVDS4` uses to compose itself
  #document;
  #digitalseal;
